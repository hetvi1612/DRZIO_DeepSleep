...
public class AllAppstorenonAdapter extends RecyclerView.Adapter<AllAppstorenonAdapter.CategoryViewholder> {
    private List<AppstoreList.NotRelated> categoryitems;
...
String BASEURL;
  ...
  /*  public AllAppstorenonAdapter(Context context, ArrayList<String> categoryitems) {
        this.categoryitems = categoryitems;
        this.context = context;
    }*/

    public AllAppstorenonAdapter(AllApp_Activity context, List<AppstoreList.NotRelated> related, Appclicklistner appclicklistner) {
    ...
    @NonNull
    @Override
    public AllAppstorenonAdapter.CategoryViewholder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_allaplist1,
                viewGroup, false);
        AllAppstorenonAdapter.CategoryViewholder viewHolder = new AllAppstorenonAdapter.CategoryViewholder(view);
    ...
    @Override
    public void onBindViewHolder(@NonNull final AllAppstorenonAdapter.CategoryViewholder categoryViewholder, final int position) {
