...
public class Activity_ShowBlogwebview extends AppCompatActivity {
    ...
    private Activity_ShowBlogwebview activity;
        ...
        sendcomment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!comment.isEmpty()) {
                    ...
                    Toast.makeText(Activity_ShowBlogwebview.this, "Please write a comment!!..", Toast.LENGTH_LONG).show();
                }
            }
        });
...
//                    Log.d("TAG1", response.code() + "");
                ...
                commentrecyclerview.setLayoutManager(new LinearLayoutManager(Activity_ShowBlogwebview.this, LinearLayoutManager.VERTICAL, false));
                Adapter_addComment adapterTopblogs = new Adapter_addComment(Activity_ShowBlogwebview.this, blogComments, activity);
