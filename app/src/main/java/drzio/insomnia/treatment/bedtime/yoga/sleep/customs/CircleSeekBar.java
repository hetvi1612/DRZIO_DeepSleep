...
public class CircleSeekBar extends View {
    ...
    private int mReachedColor, mUnreachedColor,mReachedColor2;
    ...
    public int[] colors = new int[]{getResources().getColor(R.color.mainprogresscolor),getResources().getColor(R.color.nextprogresscolor)};
    public float[] postitions =   new float[]{0.0f, 1.0f};
    ...
    private void initAttrs(AttributeSet attrs, int defStyle) {
        ...
        mReachedColor2 = a.getColor(R.styleable.CircleSeekBar_wheel_reached_colortwo, getColor(R.color.mainprogresscolor));
        colors = new int[]{mReachedColor,mReachedColor2};
    ...
    protected void onDraw(Canvas canvas) {
     ...
     /*   Shader gradient = new SweepGradient (0,getMeasuredHeight()/2, Color.RED, Color.WHITE);
        mReachedPaint.setShader(gradient);
        canvas.drawArc(new RectF(left, top, right, bottom), -90, (float)mCurAngle, false, mReachedPaint);*/
        sweepGradient = new SweepGradient(getMeasuredWidth() / 2F,getMeasuredHeight()/ 2F,colors,  postitions);
//        val rotate = 270f
//        val gradientMatrix = Matrix()
//        gradientMatrix.preRotate(rotate, mWidth / 2F, mHeight / 2F)
        Matrix gradientMatrix = new Matrix();
        gradientMatrix.preRotate(265, getMeasuredWidth() / 2F, getMeasuredHeight() / 2F);
        sweepGradient.setLocalMatrix(gradientMatrix);
        mReachedPaint.setShader(sweepGradient);
        canvas.drawArc(new RectF(left, top, right, bottom), -90, (float)mCurAngle, false, mReachedPaint);
...
//        canvas.drawArc(new RectF(left, top, right, bottom), -90, (float) mCurAngle, false, mReachedPaint);
    ...
    public void setReachedColor(int reachedColor,int reachedColor2) {
        this.mReachedColor = reachedColor;
        this.mReachedColor2 = reachedColor2;
        colors = new int[]{reachedColor,reachedColor2};
