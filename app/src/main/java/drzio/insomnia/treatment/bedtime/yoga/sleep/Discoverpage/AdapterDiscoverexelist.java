...
public class AdapterDiscoverexelist extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterDiscoverexelist(Context context, List<Daymodals> excerciseDataList, Activity excerciselist, int mLevel) {
