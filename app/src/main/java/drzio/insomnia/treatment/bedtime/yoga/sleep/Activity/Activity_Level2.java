...
import drzio.insomnia.treatment.bedtime.yoga.sleep.Fragments.Fragment_Level2;
...
//        if (!isPreviouscompleted(1) && !tinydb.getBoolean(Constants.PREMIUN_KEY)) {
//            mTemplock.setVisibility(View.VISIBLE);
//            mTemplock.setImageResource(R.drawable.img_lv2lock);
//            mTextapercentage.setVisibility(View.GONE);
//            mtxtDaylefts.setText("Unlock New Exercises");
//        } else {
//            mTemplock.setVisibility(View.GONE);
            mTextapercentage.setVisibility(View.VISIBLE);
            String percentage = tinydb.getInt(Constants.ALLDAYSPROGRESS_LV2KEY) + "%";
            String dayleft = tinydb.getString(Constants.DAYSLEFT_LV2KEY) +
                    " days left";
            mtxtDaylefts.setText(dayleft);
            mTextapercentage.setText(percentage);
            mAprogressbar.setProgress(tinydb.getInt(Constants.ALLDAYSPROGRESS_LV2KEY));
            mAprogressbar.setProgressBarColor(getResources().getColor(R.color.homeprogresscolor));
//        }

        Fragment_Level2 fragmentLevel2 = new Fragment_Level2();
        FragmentTransaction ft2 = getSupportFragmentManager().beginTransaction();
        ft2.add(R.id.framecontainer, fragmentLevel2).commit();
        ...
        mBtnremoveads.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Activity_Level2.this, Activity_Purchase.class);
    ...
    public void onBackPressed() {
       /* Intent intent = new Intent(Activity_Level2.this, MainActivity.class);
