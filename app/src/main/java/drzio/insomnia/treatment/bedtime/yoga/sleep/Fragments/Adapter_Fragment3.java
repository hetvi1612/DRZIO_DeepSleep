...
public class Adapter_Fragment3 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Adapter_Fragment3(Context context, List<Object> items, List<Weekmodel> weekdata, boolean isLastdone) {
...
//                vh2.mProgresslayout.setVisibility(View.VISIBLE);
        ...
        vh2.mBtnday.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                tinydb.putInt(Constants.ALEVEL_KEY, 3);
//                if (!daymodals.getIsLocked() || isRewarded) {
                    if (!isclicked) {
                        ...
                        if (daymodals.isIsrest()) {
                            ...
                            context.startActivity(intent);
                            ((Activity_Level3) context).finish();
                        }
                    }
//                } else {
//                    loadRewardedAd();
...
//                }
    ...
    public void isSelected(int position, Daymodals daymodals) {
        String dname = tinydb.getString(Constants.ALV3DAYCLICK_KEY);
...
//            mTotaltime = (TextView) v.findViewById(R.id.txttotaltime);
    ...
    private void showRewardedVideo(Daymodals daymodals) {
        if (rewardedAd.isLoaded()) {
            ...
            rewardedAd.show((Activity_Level3)context, adCallback);
        }
    }
